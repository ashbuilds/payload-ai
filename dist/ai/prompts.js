export const defaultPrompts = [
    ...
    {
        name: 'Summarize',
        system: ()=>`You are an expert at condensing information. Summarize the given text, capturing its key points and essential details while preserving the original meaning.
