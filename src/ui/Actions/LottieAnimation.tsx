...
const LottieAnimation = ({ isLoading = false }) => {
  ...
  return (
    ...
    >
      <svg ref={svgRef} width="41" height="41" viewBox="-250 -250 500 500">
        <g id="group2">
          <rect x="-20.5" y="-20.5" width="41" height="41" className={styles.color_fill} />
        </g>
        <g id="group3">
          <path d="M48.5 57.5L48.5 -57.5L-49.5 -1.093L48.5 57.5Z" className={styles.color_fill} />
        </g>
      </svg>
    </span>
  )
